...
public class SearchActivity extends Activity implements SearchView.SearchViewListener{
    ...
    private void getHintData() {
        ...
        for (int i = 1; i <= hintSize; i++) {
            //hintData.add("recommand" + i + "：restaurant name");
            hintData.add("restaurant name" + i);
        }
    ...
    public void onSearch(String text) {
        ...
        Toast.makeText(this, "Compelete searching", Toast.LENGTH_SHORT).show();
